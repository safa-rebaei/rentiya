...
Rentya est une application web moderne permettant la gestion et la location de maisons.
Construite avec React et Tailwind CSS (template Notus React), elle offre une interface intuitive destinée aux propriétaires, locataires et administrateurs.

✨ Description du projet

Rentya facilite la gestion des maisons, des réservations et des utilisateurs.
L’objectif est d'offrir une plateforme simple, rapide et agréable pour :
...
3️⃣ Compiler Tailwind après ajout de nouvelles classes
...
La template Notus React appartient à Creative Tim.
