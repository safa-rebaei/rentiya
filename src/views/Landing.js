...
// Import des images (en haut du fichier)
import tunisImg from "assets/img/villes/tunis.jpg";
import hammametImg from "assets/img/villes/hammamet.jpg";
import sousseImg from "assets/img/villes/sousse.jpg";
import monastirImg from "assets/img/villes/monastir.jpg";

// components
import Navbar from "components/Navbars/AuthNavbar.js";

import CardVille from "components/Cards/CardVille.js";

import Footer from "components/Footers/Footer.js";
const villes = [
  { name: "Tunis", image: tunisImg },
  { name: "Hammamet", image: hammametImg },
  { name: "Sousse", image: sousseImg },
  { name: "Monastir", image: monastirImg },
];
 ...
 <section className="pt-20 pb-20 bg-white">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-blueGray-500 mt-2">Explorez nos destinations populaires</p>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
              {villes.map((ville, index) => (
                <CardVille key={index} name={ville.name} image={ville.image} />
              ))}
            </div>
          </div>
        </section>
