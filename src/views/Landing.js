...
import armchairBg from "assets/img/armchairBg.jpg";
...
export default function Landing() {
  ...
  const tunisianCities = [
    { name: "Hammamet", image: hammametImg, link: "/hammamet" },
    { name: "Sousse", image: sousseImg, link: "/sousse" },
    { name: "Monastir", image: monastirImg, link: "/monastir" },
    { name: "Mahdia", image: mahdiaImg, link: "/mahdia" },
  ];
      ...
      <main>
        ...
        <div className="relative pt-16 pb-32 flex content-center items-center justify-center min-h-screen-75">
          <div
            ...
            style={{
              backgroundImage: `url(${armchairBg})`,
            }}
          >
            <span
              id="blackOverlay"
              ...
              <div className="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
                <div className="pr-12">
                  <h1 className="text-white font-semibold text-5xl">
                    Trouvez votre logement idéal ou louez votre bien
                    en toute simplicité.
                  </h1>
                </div>
              </div>
          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-wrap">
              ...
              <div className="lg:pt-12 pt-6 w-full md:w-4/12 px-4 text-center">
                <div className="relative flex flex-col bg-white w-full mb-8 shadow-lg rounded-lg">
                  <div className="px-4 py-5 flex-auto">
                    ...
                    <h6 className="text-xl font-semibold">Recherche intelligente</h6>
                    <p className="mt-2 mb-4 text-blueGray-500">
                      Parcourez les annonces par type, lieu, budget ou critères spécifiques.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="w-full md:w-4/12 px-4 text-center">
                <div className="relative flex flex-col bg-white w-full mb-8 shadow-lg rounded-lg">
                  <div className="px-4 py-5 flex-auto">
                    <div className="text-white p-3 inline-flex items-center justify-center w-12 h-12 mb-5 shadow-lg rounded-full bg-lightBlue-400">
                      <i className="fas fa-retweet"></i>
                    </div>
                    <h6 className="text-xl font-semibold">Gestion des annonces</h6>
                    <p className="mt-2 mb-4 text-blueGray-500">
                      Les propriétaires publient, modifient et suppriment leurs annonces facilement.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="pt-6 w-full md:w-4/12 px-4 text-center">
                <div className="relative flex flex-col bg-white w-full mb-8 shadow-lg rounded-lg">
                  <div className="px-4 py-5 flex-auto">
                    <div className="text-white p-3 inline-flex items-center justify-center w-12 h-12 mb-5 shadow-lg rounded-full bg-emerald-400">
                      <i className="fas fa-fingerprint"></i>
                    </div>
                    <h6 className="text-xl font-semibold">Prise de rendez-vous en ligne</h6>
                    <p className="mt-2 mb-4 text-blueGray-500">
                      Les locataires peuvent demander des visites et recevoir une confirmation par email.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="flex flex-wrap items-center mt-32">
              <div className="w-full md:w-5/12 px-4 mr-auto ml-auto">
                <div className="text-blueGray-500 p-3 inline-flex items-center justify-center w-16 h-16 mb-6 shadow-lg rounded-full bg-white">
                ...
                <p className="text-lg font-light leading-relaxed mt-4 mb-4 text-blueGray-600">
                  Avec Rentiya, trouvez ou gérez des biens toute l’année, rapidement et en toute sérénité.
                </p>
              ...
              <div className="w-full md:w-4/12 px-4 mr-auto ml-auto">
                <div className="relative flex flex-col bg-white w-full mb-6 shadow-lg rounded-lg bg-lightBlue-500">
                  <img
                    alt="Remise de clé"
                  ...
                  <blockquote className="relative p-8 mb-4">
                    ...
                    <p className="text-md font-light mt-2 text-white">
                      L’hiver gèle, l’été dégèle — mais votre projet avance avec Rentiya.
                    </p>
                  </blockquote>
                </div>
              </div>
                  ...
                  <div className="px-6">
                    <div className="shadow-lg rounded-lg bg-white overflow-hidden mb-6">
                      ...
                      <div className="py-4 px-6">
                        ...
                        <Link
                          to={city.link}
                          className="bg-lightBlue-500 text-white font-bold uppercase text-xs px-4 py-2 rounded shadow hover:shadow-md transition-all duration-150 inline-block"
                        >
                          En savoir plus
                        </Link>
                      </div>
          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-wrap justify-center text-center mb-24">
              <div className="w-full lg:w-6/12 px-4">
                ...
                <p className="text-lg leading-relaxed m-4 text-blueGray-500">
                  Rencontrez notre équipe passionnée qui vous accompagne.
                </p>
              </div>
            </div>
